    ...
    <div class="service-term">
        ...
        <div class="article">
            ...
            <div>
                ...
                「顧客」　　　　：ジムと契約している一般消費者をさします。本サービスの利用者ではありません。<br>
            ...
            <ol class="paragraph-list">
                ...
                <li>本取引内においてトレーナーが自ら直接若しくは別のジムと取引を行うように、ジムと契約する顧客を誘導することは禁止とします。但し、ジムとトレーナーの両者が事前に承諾した場合はこの限りではありません。</li>
                <li>本取引内においてトレーナーが顧客と連絡先を交換することは禁止とします。但し、ジムとトレーナーの両者が事前に承諾した場合はこの限りではありません。</li>
            ...
            <ol class="paragraph-list">
                ...
                <li>利用者は、利用者が第6条3項に違反した場合、ジムへの損害金として、トレーナーは金2００万円をジムに支払うものとします。</li>
            </ol>
