        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5>第8条（業務委託に関する法令の遵守）</h5>
                    <p>会員は、本サービスにおける会員間の取引において、以下の法律上の規定その他業務委託に関する法律を遵守します。</p>
                    <ol class="parentheses-list">
                    ...
                    <h5>第12条（監視業務）</h5>
                    <p>弊社は、利用者が本サービスを適正に利用しているかどうかを監視する業務を弊社の裁量により行うものとし、利用者はそれに同意するものとします。</p>

                    <h5>第13条（規約違反への対処及び違約金等）</h5>
                    <ol class="paragraph-list">
                    ...
                    <h5>第17条（本サービスの譲渡等）</h5>
                    <p>弊社は、本サービスの事業を第三者に譲渡した場合、当該事業譲渡に伴い、本サービスの運営者たる地位、本利用規約上の地位、本利用規約に基づく権利及び義務並びに会員の登録情報及びその他情報を当該事業譲渡の譲受人に譲渡することができるものとし、本サービスの会員は、会員たる地位、本規約上の地位、本利用規約に基づく権利及び義務並びに会員の登録情報その他情報の譲渡につきあらかじめ同意するものとします。</p>
                    <h5>第18条（反社会的勢力の排除）</h5>
                    <ol class="paragraph-list">
                    ...
                    <h5>第19条（基準時間）</h5>
                    <p>本サービスの提供にあたって基準となる時刻は、全て弊社のサーバ内で管理されている時刻によるものとします。</p>
                    <h5>第20条（準拠法・管轄裁判所）</h5>
                    <ol class="paragraph-list">
