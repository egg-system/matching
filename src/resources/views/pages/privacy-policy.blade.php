    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <h5>第1条（総則）</h5>
                    <p>株式会社エッグシステム（以下「当社」といいます。）は、個人情報保護を企業における重要な社会的使命・責務と認識し、当社が保有するお客様の個人情報を適切に管理運用するために遵守するべき基本事項として本保護方針を定めます。</p>
                    <h5>第2条（個人情報とは）</h5>
                    <p>当社において、個人情報とは、個人の識別に係る以下の情報をいいます。</p>
                    <ul>
                    ...
                    <h5>第3条（個人情報の取得・収集について）</h5>
                    <p>当社は、以下の方法により、個人情報を取得させていただきます。</p>
                    <ul>
                        <li>
                    ...
                    <h5>第4条（個人情報の取得・利用目的）</h5>
                    <p>当社において、当社は以下の目的のため、個人情報を適法かつ公正な手段で取得・利用させていただきます。当社は、お客様本人の同意がある場合を除き、以下の目的達成に必要な範囲を超えて、取得した個人情報を利用しません。</p>
                    <ol>
                        <li>当社サービスを提供するため</li>
                    ...
                    <h5>第5条（個人情報の利用）</h5>
                    <p>当社において、お客様の個人情報は、当社が取り扱う商品・サービス、アンケートのご案内・ご提供及びお仕事のご紹介、新商品の開発、利便性向上のために利用致します。利用する情報は、以下の方法によって取得したものを指します。</p>
                    <ol>
                    ...
                    <h5>第6条（個人情報の管理）</h5>
                    <p>当社は、個人情報の滅失、き損、漏洩及び不正利用等を防止し、その安全管理を行うために必要な措置を講じ、個人情報の取扱責任者を設置し、個人情報を安全に管理します。また、当社は個人情報を利用目的の範囲内において、正確かつ最新の状態で管理するように努めます。</p>
                    <h5>第7条（個人情報の第三者への提供・開示）</h5>
                    ...
                    <h5>第8条（個人情報の開示・訂正・利用停止）</h5>
                    <p>当社は、お客様から個人情報の開示、内容の訂正・追加・削除及び利用停止を求められた場合には適切にこれに対応します。但し、個人情報保護法その他の法令により、当社がこれらの義務を負わない場合は、この限りではありません。</p>
                    <h5>第9条（クッキー（Cookie））</h5>
                    <p>
                    ...
                    <h5>第11条（継続的改善）</h5>
                    <p>当社は、個人情報保護に関する取扱い、管理及び管理体制について継続的改善を行います。</p>
                    <h5>第12条（改訂）</h5>
                    <p>本保護方針は、当社の判断によりお客様の同意なしに全部又は一部の改訂を行うことができるものとし、本保護方針改訂後にお客様が当社サービスを利用した場合には、当該改訂に同意したものとみなします。ただし、本保護方針の内容を大幅に改訂する場合については当社上においてお知らせいたします。</p>
                </div>
            </div>
        </div>
    </div>
